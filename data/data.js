...
export const fullStackProjects = [
    ...
    },
    {
        ...
        title: 'InHouse Besoccer Project',
...
export const wordpressProjects = [
    {
        ...
        description: 'Digital Company Website',
    ...
    },
    {
        id: 'bang',
        title: 'Bang Studio',
        description: 'Customized Sneakers Store',
    ...
    },
    {
        id: 'oestevaquero',
        title: 'Oeste Vaquero',
        description: 'Niche Amazon website',
...
export const stack = [
    {
        title: 'Full Stack',
        description: [
            'We love to the develop websites, APIS, databases, whatever you need... See my last personal project <a href="https://www.weteachfrontend.com/react" class="link-highlight">here!</a> and value my skills. Hope you like it : )',
...
export const aboutMeCards = [
    {
        ...
        description: 'You don\'t know a place until you live there. Working in these big cities opened my mind to another level. Now I enjoy going back home, my hometown, and the people who are always around.',
        buttonText: 'Go to Instagram',
        buttonUrl: 'https://www.instagram.com/eliasmmata/'
    },
    {
        title: 'From University to a self-taught person.',
        description: 'If my degree in Pedagogy taught me something, it was the importance of continuous learning. That is why I never stop meeting and adopting new things in this wonderful world of programming and design. I am an eclectic person, trying to connect the dots as that wonderful mind once said. Now, finally, I can consider myself a <span class="color-change text-bold">Full Stack Developer.</span>',
        buttonText: 'Go to Linkedin',
        buttonUrl: 'https://www.linkedin.com/in/pabloeliasmorenomata/'
    },
    {
        title: 'Vital CV',
        description: 'I wanted to collect all the teachings outside the classical curriculum. All the readings, learnings, talks and wisdom of extraordinary people that made an impact to me are collected here. Everything I absorbed made me the person that I am. Here you can see it.',
